	...
	<view class="box" :style='{"minHeight":"100vh","width":"100%","padding":"120rpx 44rpx 244rpx 44rpx","background":"url(http://clfile.zggen.cn/20231204/89b286cdb44c4f3e9a91bc90ff72c4e2.jpg) no-repeat center top / 100% 100%,#ffffff","height":"100%"}'>
		<view :style='{"padding":"48rpx 48rpx 48rpx 48rpx","boxShadow":"0px 0px 0px #dddddd","margin":"0 0 244rpx 0","borderRadius":"4rpx","background":"none","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='yonghu'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.yonghuzhanghao" type="text" class="uni-input" name="" placeholder="用户账号" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='yonghu'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.yonghumima" type="password" class="uni-input" name="" placeholder="用户密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='yonghu'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.yonghumima2" type="password" class="uni-input" name="" placeholder="确认用户密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='yonghu'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.yonghuxingming" type="text" class="uni-input" name="" placeholder="用户姓名" />
			</view>
			...
			<picker :style='{"border":"2rpx solid #00000010","padding":"0 20rpx","margin":"0 0 24rpx 0","borderRadius":"60rpx","background":"#ffffff","width":"100%","height":"auto"}' v-if="tableName=='yonghu'"  @change="yonghuxingbieChange" :value="yonghuxingbieIndex" :range="yonghuxingbieOptions">
			...
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.lvxingshezhanghao" type="text" class="uni-input" name="" placeholder="旅行社账号" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.lvxingshemima" type="password" class="uni-input" name="" placeholder="旅行社密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.lvxingshemima2" type="password" class="uni-input" name="" placeholder="确认旅行社密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.lvxingshexingming" type="text" class="uni-input" name="" placeholder="旅行社姓名" />
			</view>
            <view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" @tap="lvxingshetouxiangTap" class="">
                <view>请上传头像</view>
                <image :style='{"width":"160rpx","borderRadius":"16rpx","objectFit":"contain","background":"#fff","display":"block","height":"120rpx"}' v-if="ruleForm.touxiang" class="avator" :src="baseUrl+ruleForm.touxiang" mode=""></image>
                <image :style='{"width":"160rpx","borderRadius":"16rpx","objectFit":"contain","background":"#fff","display":"block","height":"120rpx"}' v-else class="avator" src="../../static/gen/upload.png" mode=""></image>
            </view>
			<picker :style='{"border":"2rpx solid #00000010","padding":"0 20rpx","margin":"0 0 24rpx 0","borderRadius":"60rpx","background":"#ffffff","width":"100%","height":"auto"}' v-if="tableName=='lvxingshe'"  @change="lvxingshexingbieChange" :value="lvxingshexingbieIndex" :range="lvxingshexingbieOptions">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#666"}' class="uni-input">{{ruleForm.xingbie?ruleForm.xingbie:"请选择性别"}}</view>
			</picker>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='lvxingshe'" class="uni-form-item uni-column">
				<input :style='{"border":"0px solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#666","borderRadius":"60rpx","background":"#ffffff","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.shoujihao" type="text" class="uni-input" name="" placeholder="手机号" />
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='lvxingshe'){
				...
				this.ruleForm.xingbie=this.lvxingshexingbieOptions[0]
			}
		...
		methods: {
			...
			async register() {
                ...
                if(`lvxingshe` == this.tableName && (this.ruleForm.lvxingshemima!=this.ruleForm.lvxingshemima2)){
                    this.$utils.msg(`两次密码输入不一致`);
                    return
                }
